...
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener {
    ...
    HashMap<String,String> listDevice = new HashMap<>();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.atn_direct_discover:
                ...
                record.put("test", "LongTest");
                // Service information.  Pass it an instance name, service type
                // _protocol._transportlayer , and the map containing
                // information other devices will want once they connect to this one.
                WifiP2pDnsSdServiceInfo serviceInfo =
                        WifiP2pDnsSdServiceInfo.newInstance("_test_Long", "_presence._tcp", record);
...
//                        bundle.putString(device.deviceAddress, record.get("test").toString());
                        if(record.containsKey("test"))
                        bundle.putString(device.deviceAddress, record.get("test").toString());
                    }
                };
...
//                                .get(resourceType.deviceAddress) : resourceType.deviceName;
                        ...
                        if(bundle.containsKey(resourceType.deviceAddress) && !listDevice.containsKey(resourceType.deviceAddress)){
                            ...
                            //adapter.
                            //adapter.clear();
                            listDevice.put(resourceType.deviceAddress,"1");
                ...
                manager.discoverServices(channel, new ActionListener() {
                    ...
                    public void onSuccess() {
                        // Success!
                        Toast.makeText(WiFiDirectActivity.this, "Discovery Service Initiated",
                                Toast.LENGTH_SHORT).show();
                    }
