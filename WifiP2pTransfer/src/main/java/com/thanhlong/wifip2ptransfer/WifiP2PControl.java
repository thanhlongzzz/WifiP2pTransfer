...
public class WifiP2PControl implements WifiP2pManager.PeerListListener, WifiP2pManager.ChannelListener, WifiP2pManager.ConnectionInfoListener {
    ...
    private static OnP2PListener onP2PListener;
    ...
    public boolean isWifiP2pReady() {
        return isWifiP2pReady;
    }
    ...
    private void init(Activity context) {
        ...
        WifiP2PDevicePIN connected = new WifiP2PDevicePIN();
        connected.deviceName = sharedPreferences.getString("connectedDevice", null);
...
//                                .get(resourceType.deviceAddress) : resourceType.deviceName;
    ...
    public void connect(final WifiP2PDevicePIN device) {
        ...
        try {
            ...
            onConnectionInfoAvailable(this.info);
        }
...
//        }
    ...
    public void onConnectionInfoAvailable(WifiP2pInfo info) {
        //connected
        this.info = info;
        new FileServerAsyncTask(context, receiverFolder).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
...
//        }
    ...
    public void sendFile(String path, OnFileTransfer onFileTransfer) {
        WifiP2PControl.onFileTransfer = onFileTransfer;
        actionSend(path);
    }

    private void actionSend(String path) {
    ...
    public class FileServerAsyncTask extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                // String test = sharedPreferences.getString("connectedIP","");
                ...
                sharedPreferences.edit().putString("connectedDevice", fromDevice).apply();
                setConnectedDevice(from);
//                if(from.deviceName!=null){
//                    if(!from.deviceName.equals("")){
//                       // onP2PListener.onConnected(from);
//                    }
//                }
...
//                    if (onFileTransfer != null) {
////                        onFileTransfer.onCopiedSuccess();
////                    }
                    return "sendSuccess";
                }
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                if (WifiP2PControl.onFileTransfer != null) {
                    WifiP2PControl.onFileTransfer.onCopied(result);
                }
